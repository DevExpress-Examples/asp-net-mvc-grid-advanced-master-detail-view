@ModelType AdvancedMasterDetail.Models.Supplier
    ...
    @Html.DevExpress().PageControl(Sub(settings)
                                       ...
                                       settings.TabPages.Add("Products").SetContent(Sub()
                                                                                        ...
                                                                                        Html.RenderAction("ProductsGridViewPartial", New With {.key = Model.SupplierID})

                                                                                    End Sub)
                                       settings.TabPages.Add("Categories").SetContent(Sub()
    
                                                                                          Html.RenderAction("CategoryGridViewPartial", New With {.key = Model.SupplierID})
